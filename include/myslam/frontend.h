...
namespace myslam {
    ...
    class Frontend {
        ...
        private:
            ...
            SE3 relative_motion_;  // The relative motion between the current frame and the previous frame, which is used to estimate the initial pose value of the current frame
